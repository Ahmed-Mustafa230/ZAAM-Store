          ...
          <form onSubmit={handleSendOtp} className='mt-8 space-y-5'>
            ...
            <div>
              ...
              <div className='relative mt-1.5'>
                <input
                  ...
                  className={`w-full rounded-lg border bg-[var(--color-cream)] px-4 py-3 pr-12 text-sm text-[var(--color-primary)] placeholder:text-[var(--color-mid-gray)] focus:ring-1 focus:ring-[var(--color-accent)] transition-all ${
            ...
            <label className='flex items-start gap-2 cursor-pointer'>
              <input
                ...
                className='mt-0.5 h-5 w-5 rounded border-[var(--color-light-gray)] text-[var(--color-accent)] focus:ring-[var(--color-accent)]'
              />
