    ...
    <div className='min-h-screen bg-[var(--color-off-white)] flex items-center justify-center p-4 font-[family-name:var(--font-body)]'>
      <div className='w-full max-w-md'>
        ...
        <div className='glass-card p-8 sm:p-10'>
          ...
          <button className='flex w-full items-center justify-center gap-3 rounded-lg border border-[var(--color-light-gray)] bg-[var(--color-white)] px-4 py-3 text-sm font-medium text-[var(--color-dark-gray)] hover:bg-[var(--color-cream)] transition-all'>
