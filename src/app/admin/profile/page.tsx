                    ...
                    <div className='mt-4 flex justify-center gap-2 sm:gap-3'>
                      {otp.map((digit, i) => (
                        <input
                          ...
                          className='h-12 w-9 sm:h-14 sm:w-12 rounded-lg border border-[var(--color-light-gray)] bg-[var(--color-cream)] text-center text-xl font-bold text-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-accent)] focus:border-[var(--color-accent)] outline-none'
                        />
                      ))}
                    </div>
                    ...
                    <div>
                      ...
                      <div className='relative mt-1'>
                        <input
                          ...
                          className='w-full rounded-lg border border-[var(--color-light-gray)] bg-[var(--color-cream)] px-4 py-3 pr-12 text-sm text-[var(--color-primary)] focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)] outline-none'
                        />
                        <button
                          type='button'
