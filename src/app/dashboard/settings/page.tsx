                  ...
                  <div className='mt-4 flex justify-center gap-2 sm:gap-3'>
                    {otp.map((digit, i) => (
                      <input
                        ...
                        className='h-12 w-9 sm:h-14 sm:w-12 rounded-lg border border-[var(--color-light-gray)] dark:border-zinc-700 bg-[var(--color-cream)] dark:bg-zinc-800 text-center text-xl font-bold text-[var(--color-primary)] dark:text-zinc-100 focus:ring-1 focus:ring-[var(--color-accent)] focus:border-[var(--color-accent)] outline-none'
                      />
                    ))}
                  </div>
                  ...
                  <div>
                    ...
                    <div className='relative mt-1'>
                      <input
                        ...
                        className='w-full rounded-lg border border-[var(--color-light-gray)] dark:border-zinc-700 bg-[var(--color-cream)] dark:bg-zinc-800 px-4 py-3 pr-12 text-sm text-[var(--color-primary)] dark:text-zinc-100 focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)] outline-none'
                      />
                      <button
                        type='button'
                        onClick={() => setShowPassword(!showPassword)}
                        className='absolute right-3 top-1/2 -translate-y-1/2 flex items-center justify-center h-9 w-9 text-[var(--color-mid-gray)] hover:text-[var(--color-primary)] dark:hover:text-zinc-100 transition-colors'
