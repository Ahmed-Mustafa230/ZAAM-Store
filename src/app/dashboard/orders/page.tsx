...
const allOrders: Order[] = [
  { id: '#ZAAM-004832', date: '2026-06-28', status: 'Delivered', total: 2145, items: 3, products: [{ name: 'Classic Fit Wool Blazer', qty: 1, price: 1295 }, { name: 'Italian Leather Derby Shoes', qty: 1, price: 895 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' }, tracking: '1Z999AA10123456784' },
  { id: '#ZAAM-004701', date: '2026-06-15', status: 'Shipped', total: 895, items: 1, products: [{ name: 'Italian Leather Derby Shoes', qty: 1, price: 895 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' }, tracking: '1Z999AA10123456785' },
  { id: '#ZAAM-004589', date: '2026-05-30', status: 'Processing', total: 3450, items: 2, products: [{ name: 'Cashmere Turtleneck Sweater', qty: 1, price: 1450 }, { name: 'Silk Evening Gown', qty: 1, price: 2000 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' } },
  { id: '#ZAAM-004412', date: '2026-05-12', status: 'Delivered', total: 1290, items: 1, products: [{ name: 'Double-Breasted Wool Coat', qty: 1, price: 1290 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' } },
  { id: '#ZAAM-004398', date: '2026-04-28', status: 'Cancelled', total: 520, items: 1, products: [{ name: 'Leather Aviator Sunglasses', qty: 1, price: 520 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' } },
  { id: '#ZAAM-004201', date: '2026-04-10', status: 'Delivered', total: 1895, items: 1, products: [{ name: 'Double-Breasted Wool Coat', qty: 1, price: 1895 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' } },
  { id: '#ZAAM-004105', date: '2026-03-22', status: 'Delivered', total: 2150, items: 2, products: [{ name: 'Monogram Canvas Backpack', qty: 1, price: 2150 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' } },
  { id: '#ZAAM-003987', date: '2026-03-05', status: 'Pending', total: 480, items: 1, products: [{ name: 'Leather Aviator Sunglasses', qty: 1, price: 480 }], shipping: { name: 'Alexander Blackwood', address: '742 Park Avenue', city: 'New York', state: 'NY', zip: '10021', country: 'United States' } },
];
